...
CODEC_SRC = vendor/cjson/cJSON.c src/safetensors.c src/wlrn.c src/ir.c src/instance.c src/model_mlp.c src/modelzoo/modelzoo.c src/modelzoo/models/gpt2.c src/modelzoo/hf_loader.c
