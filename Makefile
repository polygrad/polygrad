...
.PHONY: all test test-fast test-parity test-parity-opt test-parity-cuda test-wasm test-wasm-new test-native test-browser test-p2p test-p2p-browser bench bench-cuda bench-train-c bench-train-py bench-ratios bench-compare bench-regression bench-update-baseline wasm wasm-pkg clean analyze cppcheck format format-check test-msan verify coverage
