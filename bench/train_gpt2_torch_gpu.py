#!/usr/bin/env python
"""Benchmark: GPT-2 training loop with PyTorch (CUDA GPU) for comparison."""
...
print(f"{'='*70}")
print(f"GPT-2 Training Benchmark (PyTorch {torch.__version__} CUDA, eager)")
...
print(f"{'='*70}")
print(f"PyTorch {torch.__version__} CUDA eager (no torch.compile, no Flash Attention)")
print(f"{'='*70}")
