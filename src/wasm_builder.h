...
#define WASM_OP_I64_TRUNC_F32_S 0xAE
#define WASM_OP_I64_TRUNC_F32_U 0xAF
...
#define WASM_OP_F32_CONVERT_I64_U 0xB5
...
#define WASM_OP_F64_CONVERT_I64_U 0xBA
...
#define WASM_SIMD_V128_LOAD32_SPLAT 0x09
#define WASM_SIMD_V128_STORE 0x0B
#define WASM_SIMD_V128_CONST 0x0C
#define WASM_SIMD_I8X16_SHUFFLE 0x0D
#define WASM_SIMD_I32X4_SPLAT 0x11
#define WASM_SIMD_I32X4_EXTRACT 0x1B
#define WASM_SIMD_I32X4_REPLACE 0x1C
#define WASM_SIMD_I32X4_EQ 0x37
#define WASM_SIMD_I32X4_NE 0x38
#define WASM_SIMD_I32X4_LT_S 0x39
#define WASM_SIMD_I32X4_LT_U 0x3A
#define WASM_SIMD_F32X4_SPLAT 0x13
#define WASM_SIMD_F32X4_EXTRACT 0x1F
#define WASM_SIMD_F32X4_REPLACE 0x20
#define WASM_SIMD_F32X4_EQ 0x41
#define WASM_SIMD_F32X4_NE 0x42
#define WASM_SIMD_F32X4_LT 0x43
#define WASM_SIMD_F64X2_EQ 0x47
#define WASM_SIMD_F64X2_NE 0x48
#define WASM_SIMD_F64X2_LT 0x49
#define WASM_SIMD_V128_AND 0x4E
#define WASM_SIMD_V128_ANDNOT 0x4F
#define WASM_SIMD_V128_OR 0x50
#define WASM_SIMD_V128_XOR 0x51
...
#define WASM_SIMD_F32X4_RELAXED_MADD 0x105
#define WASM_SIMD_V128_BITSELECT 0x52
#define WASM_SIMD_V128_LOAD32_ZERO 0x5C
#define WASM_SIMD_V128_LOAD64_ZERO 0x5D
#define WASM_SIMD_V128_STORE32_LANE 0x5A
#define WASM_SIMD_V128_STORE64_LANE 0x5B
#define WASM_SIMD_F32X4_DEMOTE_F64X2_ZERO 0x5E
#define WASM_SIMD_F64X2_PROMOTE_LOW_F32X4 0x5F

/* f64x2 SIMD (prefixed: 0xFD + LEB128 sub-opcode) */
#define WASM_SIMD_F64X2_EXTRACT 0x21
#define WASM_SIMD_F64X2_REPLACE 0x22
...
#define WASM_SIMD_I32X4_TRUNC_SAT_F32X4_S 0xF8
#define WASM_SIMD_I32X4_TRUNC_SAT_F32X4_U 0xF9
#define WASM_SIMD_F32X4_CONVERT_I32X4_S 0xFA
#define WASM_SIMD_F32X4_CONVERT_I32X4_U 0xFB
#define WASM_SIMD_I32X4_TRUNC_SAT_F64X2_S_ZERO 0xFC
#define WASM_SIMD_I32X4_TRUNC_SAT_F64X2_U_ZERO 0xFD
#define WASM_SIMD_F64X2_CONVERT_LOW_I32X4_S 0xFE
#define WASM_SIMD_F64X2_CONVERT_LOW_I32X4_U 0xFF

/* i64x2 SIMD (prefixed: 0xFD + LEB128 sub-opcode) */
#define WASM_SIMD_I64X2_SPLAT 0x12
#define WASM_SIMD_I64X2_EXTRACT 0x1D
#define WASM_SIMD_I64X2_REPLACE 0x1E
